...
import ToursRoute from "./routes/Productdetail/Productdetail-route.component.jsx"
    ...
    <div className="App">
      ...
      <AuthProvider value={{ currentUser, timeActive, setTimeActive }}>
        ...
        <Routes>
          ...
          <Route path="CBlog" element={<CBlog setActive={setActive} user={user} active={active} />} />
          <Route path="/search" element={<CBlog setActive={setActive} user={user} />} />
          <Route path="/detail/:id" element={<Detail user={user} />} />


          <Route path="/contact-us" element={<ContactRoute />} />

          <Route path="/featuredproduct/:id" element={<ToursRoute />} />
          <Route path="/product/:id" element={<TourDetailsRoute />} />
